        ...
        <div className="form-container">
            ...
            <form onSubmit={handleSubmit}>
                <div className="form-section">
                    <h2>Dados do Serviço Contratado</h2>
                ...
                <div className="form-actions">
                    <button 
                        type="submit" 
                        disabled={loading || !formData.employee_id || !formData.work_id || 
            ...
            <ConfirmDialog
                ...
                message="Tem certeza que deseja deletar este serviço contratado?"
            />
        </div>
    );
};

export default ContractedServiceForm; 